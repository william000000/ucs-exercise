$(document).ready(function () {
  ...
  $(document).on("click", ".relatedHashtag .bar__item", function () {
    if (!$(this).hasClass("bar__item--active")) {
      ...
      var tagParameter = $(this).attr("data-hashtag");
      var maxArticles = $(this).attr("data-maxarticle");
      getResult(tagParameter, maxArticles);
    }
  });
  ...
  function getResult(tagParameter, maxArticles) {
    ...
    $.ajax({
      url: `/bin/hashtag?tag=${tagParameter}&max=${maxArticles}`,
      type: "GET",
